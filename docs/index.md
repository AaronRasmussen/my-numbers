...
Transaction data and account information are entered in a few tables, but that data is leveraged to create a diverse range of viewing options (click [here for the full image gallery](image-gallery.md)):

- [_Account Ledger:_](image-gallery.md#account-ledger) View transaction information for any account and for any period of time
...
- _Search:_ A comprehensive search engine that lets you dig down into your transaction history
- _Net Worth:_ View your net worth by month
- _Debts:_ See a list of your debts, the amounts paid so far, and the amounts still owed
